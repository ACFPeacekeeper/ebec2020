    ...
    ? (
        ($.Unslider = function(t, n) {
          ...
          return (e._ = "unslider"), (e.defaults = {
            ...
            swipe: !0,
            swipeThreshold: 0.2
          }), (e.$context = t), (e.options = {}), (e.$parent = null), (e.$container = null), (e.$slides = null), (e.$nav = null), (e.$arrows = []), (e.total = 0), (e.current = 0), (e.prefix =
            e._ + "-"), (e.eventSuffix =
            "." +
            e.prefix +
            ~~(2e3 * Math.random())), (e.interval = null), (e.init = function(
            t
          ) {
            return (e.options = $.extend(
              {},
              e.defaults,
              t
            )), (e.$container = e.$context
              .find(e.options.selectors.container)
              .addClass(e.prefix + "wrap")), (e.$slides = e.$container.children(
            ...
            ), jQuery.event.special.swipe && e.options.swipe && e.initSwipe(), e
              .options.autoplay &&
              e.start(), e.calculateSlides(), e.$context.trigger(
              e._ + ".ready"
            ...
            "static" === t &&
              e.$context.css("position", "relative"), e.$context.css(
              "overflow",
              "hidden"
            );
            ...
            if (
              ...
              "vertical" === e.options.animation &&
                (t = "height"), e.$container
                .css(t, 100 * e.total + "%")
                .addClass(e.prefix + "carousel"), e.$slides.css(
                t,
                100 / e.total + "%"
              );
            }
            ...
            e.$slides.each(function(n) {
              ...
              $.isFunction(e.options.nav) &&
                (i = e.options.nav.call(
                  e.$slides.eq(n),
                  n,
                  i
                )), t.children("ol").append('<li data-slide="' + n + '">' + i + "</li>");
            }), (e.$nav = t.insertAfter(e.$context)), e.$nav
              .find("li")
            ...
            e.options.arrows === !0 &&
              (e.options.arrows = e.defaults.arrows), $.each(
              e.options.arrows,
              function(t, n) {
                e.$arrows.push(
                  $(n).insertAfter(e.$context).on("click" + e.eventSuffix, e[t])
                );
              }
            );
          }), (e.initKeys = function() {
            e.options.keys === !0 && (e.options.keys = e.defaults.keys), $(
              document
            ).on("keyup" + e.eventSuffix, function(t) {
            ...
            return 0 > t && (t = e.total - 1), (e.current = Math.min(
              Math.max(0, t),
              e.total - 1
            )), e.options.nav &&
              e.$nav
                .find('[data-slide="' + e.current + '"]')
                ._active(e.options.activeClass), e.$slides
              .eq(e.current)
              ._active(e.options.activeClass), e;
            ...
            if (
              ...
              return e;
            e.options.autoplay && e.stop().start(), e.setIndex(
              t
            ...
            var n = "left";
            return "rtl" === e.$context.attr("dir") && (n = "right"), e.options
              .infinite && e.$container.css("margin-" + n, "-100%"), e.slide(
              n,
              t
            );
          }), (e.animateVertical = function(t) {
            return (e.options.animateHeight = !0), e.options.infinite &&
              e.$container.css("margin-top", -e.$slides.outerHeight()), e.slide(
              "top",
              t
            );
            ...
            if (
              ...
              var i;
              n === e.total - 1 && ((i = e.total - 3), (n = -1)), n ===
                e.total - 2 && ((i = 0), (n = e.total - 2)), "number" ==
                typeof i &&
                (
                  e.setIndex(i),
