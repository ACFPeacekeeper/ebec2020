jQuery(function($) {
	...
	/* =============== SHOW / HIDE FAQ =============== */
	$("#nino-faq .nino-sectionHeading1").click(function(){
		$("#nino-faq").toggleClass("showFaq");
		$(this).find(".text").toggle();
	});

	/* =============== SHOW / HIDE DOC1 =============== */
	$("#nino-doc .nino-sectionHeading1").click(function(){
		$("#nino-doc").toggleClass("showDoc");
		$(this).find(".text").toggle();
	});
	
	
	/* =============== SHOW / HIDE HORARIO =============== */
	$("#nino-hor .nino-sectionHeading1").click(function(){
		$("#nino-hor").toggleClass("showHor");
		$(this).find(".text").toggle();
	});

	/* =============== SHOW / HIDE HORARIO 2 =============== */
	$("#nino-hor2 .nino-sectionHeading1").click(function(){
		$("#nino-hor2").toggleClass("showHor2");
		$(this).find(".text").toggle();
	});

	/* =============== SHOW / HIDE PARCEIROS =============== */
	$("#nino-par .nino-sectionHeading1").click(function(){
		$("#nino-par").toggleClass("showpar");
		$(this).find(".text").toggle();
	});
	...
	/* =============== SHOW / HIDE TEAM =============== */
	$("#nino-team .nino-sectionHeading1").click(function(){
		$("#nino-team").toggleClass("showteam");
		$(this).find(".text").toggle();
	});
